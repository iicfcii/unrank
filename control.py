...
def save_templates():
    img = cv2.imread('template_src/nepal_600.jpg', cv2.IMREAD_COLOR)
    cv2.imwrite('template/control_locked.jpg', utils.crop(img, LOCKED_RECT))

    img = cv2.imread('template_src/nepal_2130.jpg', cv2.IMREAD_COLOR)
    cv2.imwrite('template/control_c_0.jpg', utils.crop(img, UNLOCKED_RECT))
    img = cv2.imread('template_src/nepal_2760.jpg', cv2.IMREAD_COLOR)
    cv2.imwrite('template/control_c_1.jpg', utils.crop(img, UNLOCKED_RECT))
    img = cv2.imread('template_src/nepal_6780.jpg', cv2.IMREAD_COLOR)
    cv2.imwrite('template/control_c_2.jpg', utils.crop(img, UNLOCKED_RECT))

    img = cv2.imread('template_src/nepal_11910.jpg', cv2.IMREAD_COLOR)
    cv2.imwrite('template/control_b_0.jpg', utils.crop(img, UNLOCKED_RECT))
    img = cv2.imread('template_src/nepal_12180.jpg', cv2.IMREAD_COLOR)
    cv2.imwrite('template/control_b_1.jpg', utils.crop(img, UNLOCKED_RECT))
    img = cv2.imread('template_src/nepal_13650.jpg', cv2.IMREAD_COLOR)
